...
psiphon_location() {
    ...
    echo -e "${purple}2)${cyan} Belgium (BE)${rest}"
    echo -e "${purple}3)${cyan} Bulgaria (BG)${rest}"
    echo -e "${purple}4)${cyan} Brazil (BR)${rest}"
    echo -e "${purple}5)${cyan} Canada (CA)${rest}"
    echo -e "${purple}6)${cyan} Switzerland (CH)${rest}"
    echo -e "${purple}7)${cyan} Czech Republic (CZ)${rest}"
    echo -e "${purple}8)${cyan} Germany (DE)${rest}"
    echo -e "${purple}9)${cyan} Denmark (DK)${rest}"
    echo -e "${purple}10)${cyan} Estonia (EE)${rest}"
    echo -e "${purple}11)${cyan} Spain (ES)${rest}"
    echo -e "${purple}12)${cyan} Finland (FI)${rest}"
    echo -e "${purple}13)${cyan} France (FR)${rest}"
    echo -e "${purple}14)${cyan} United Kingdom (GB)${rest}"
    echo -e "${purple}15)${cyan} Hungary (HU)${rest}"
    echo -e "${purple}16)${cyan} Ireland (IE)${rest}"
    echo -e "${purple}17)${cyan} India (IN)${rest}"
    echo -e "${purple}18)${cyan} Italy (IT)${rest}"
    echo -e "${purple}19)${cyan} Japan (JP)${rest}"
    echo -e "${purple}20)${cyan} Latvia (LV)${rest}"
    echo -e "${purple}21)${cyan} Netherlands (NL)${rest}"
    echo -e "${purple}22)${cyan} Norway (NO)${rest}"
    echo -e "${purple}23)${cyan} Poland (PL)${rest}"
    echo -e "${purple}24)${cyan} Romania (RO)${rest}"
    echo -e "${purple}25)${cyan} Serbia (RS)${rest}"
    echo -e "${purple}26)${cyan} Sweden (SE)${rest}"
    echo -e "${purple}27)${cyan} Singapore (SG)${rest}"
    echo -e "${purple}28)${cyan} Slovakia (SK)${rest}"
    echo -e "${purple}29)${cyan} Ukraine (UA)${rest}"
    echo -e "${purple}30)${cyan} United States (US)${rest}"
